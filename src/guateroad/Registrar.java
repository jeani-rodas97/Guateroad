...
public class Registrar extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel5.setBounds(290, 320, 80, 17);
        ...
        txtTelefono.setBounds(270, 260, 220, 30);
        ...
        jLabel8.setBounds(140, 190, 80, 17);

        jLabel9.setFont(new java.awt.Font("Georgia", 0, 14)); // NOI18N
        jLabel9.setForeground(new java.awt.Color(255, 255, 255));
        jLabel9.setText("Latitud");
        getContentPane().add(jLabel9);
        jLabel9.setBounds(30, 320, 80, 17);

        Lon.setFont(new java.awt.Font("Georgia", 0, 14)); // NOI18N
        Lon.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                LonActionPerformed(evt);
            }
        });
        getContentPane().add(Lon);
        Lon.setBounds(350, 310, 140, 30);

        Lat.setFont(new java.awt.Font("Georgia", 0, 14)); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        {
            Guateroad.bConductor.Insertar(Guateroad.ArbolConductor.ConsultarId());
            arbolb.Persona Usuario = new arbolb.Persona(Guateroad.ArbolConductor.ConsultarId(), txtNombre.getText(), txtUsuario.getText(), "Conductor", txtPass.getText(), txtCorreo.getText(), txtTelefono.getText(), true);
            Guateroad.ArbolConductor.AgregarEnB(Guateroad.ArbolConductor.ConsultarId(), Usuario);
            JOptionPane.showMessageDialog(null, "Usuario conductor creado");
        }
        
        if(rbtNormal.isSelected())
        {
            Guateroad.bUsuario.Insertar(Guateroad.ArbolConductor.ConsultarId());
            arbolb.Persona Usuario = new arbolb.Persona(Guateroad.ArbolUsuario.ConsultarId(), txtNombre.getText(), txtUsuario.getText(), "Conductor", txtPass.getText(), txtCorreo.getText(), txtTelefono.getText(), true);
            Guateroad.ArbolUsuario.AgregarEnB(Guateroad.ArbolUsuario.ConsultarId(), Usuario);
