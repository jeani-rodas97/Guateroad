...
public class Conductor extends javax.swing.JFrame {
    ...
    public Conductor() {
        ...
        {
            if(Guateroad.ArbolFacturas.fact.get(i).getIdConductor() == Guateroad.id)
            {
                Guateroad.ArbolFacturas.fact.get(i).getPrecio();
                tabla.addRow(new Object[]{"Viaje "+ Guateroad.ArbolFacturas.fact.get(i).getIdViaje(), Guateroad.ArbolFacturas.fact.get(i).getFecha(),"Q"+Guateroad.ArbolFacturas.fact.get(i).getPrecio()});
            }
        }
    ...
    private void bttCerrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bttCerrarActionPerformed
        Guateroad.ArbolConductor.BorrarPersona(Guateroad.id);
        Login lg = new Login();
        lg.setVisible(true);
        dispose();
