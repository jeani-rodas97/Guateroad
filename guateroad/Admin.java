...
public class Admin extends javax.swing.JFrame {
    ...
    public Admin() {
        ...
        lbl4.setText(Guateroad.fn.EncriptarSHA256("admin"));
    }
    ...
    private void initComponents() {
        ...
        bttRepViaj = new javax.swing.JButton();
        bttRepFacts = new javax.swing.JButton();
        ...
        bttRepViaj.setFont(new java.awt.Font("Georgia", 0, 14)); // NOI18N
        bttRepViaj.setText("Reporte Viajes");
        bttRepViaj.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                bttRepViajActionPerformed(evt);
            }
        });
        getContentPane().add(bttRepViaj);
        bttRepViaj.setBounds(480, 220, 180, 25);

        bttRepFacts.setFont(new java.awt.Font("Georgia", 0, 14)); // NOI18N
        bttRepFacts.setText("Reporte Facturas");
        bttRepFacts.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                bttRepFactsActionPerformed(evt);
            }
        });
        getContentPane().add(bttRepFacts);
        bttRepFacts.setBounds(480, 270, 180, 25);
    ...
    private void bttJuserActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bttJuserActionPerformed
        String nombre, usuario, correo, pass, tel, rol, pss; 
        int idJ;
        ...
        try {
            ...
            for(int i = 0; i < docJson.length(); i++)
            {
                ...
                if(rol.equals("conductor")) {
                    ...
                    Guateroad.ArbolConductor.InsertarPersona(NuevoUser);
                ...
                if(rol.equals("normal")) {
                    ...
                    Guateroad.ArbolUsuario.InsertarPersona(NuevoUser);
    ...
    private void bttJinicialActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bttJinicialActionPerformed
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, "Loc de usuarios cargados correctamente");
        }
        catch(Exception e) {
        }
    ...
    private void bttRepViajActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bttRepViajActionPerformed
        String comando = "cmd /c dot RepV.dot -Tpdf -o RepV.pdf ";
        String dot;
        dot = Guateroad.bViajes.Graficar();
        try{
            File arch = new File("RepV.dot");
            if(!arch.exists())
                arch.createNewFile();
    ...
    }//GEN-LAST:event_bttRepViajActionPerformed

    private void bttRepFactsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bttRepFactsActionPerformed
        String comando = "cmd /c dot RepF.dot -Tpdf -o RepF.pdf ";
        String dot;
        dot = Guateroad.bFacturas.Graficar();
        try{
            File arch = new File("RepF.dot");
            if(!arch.exists())
                arch.createNewFile();
    ...
    }//GEN-LAST:event_bttRepFactsActionPerformed
    ...
    private javax.swing.JButton bttRepFacts;
    private javax.swing.JButton bttRepLug;
    private javax.swing.JButton bttRepUs;
    private javax.swing.JButton bttRepViaj;
