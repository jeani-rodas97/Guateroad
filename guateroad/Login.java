...
public class Login extends javax.swing.JFrame {
    ...
    private void bttLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bttLoginActionPerformed
        String Usuario, password, pss; 
        Usuario = txtUsuario.getText();
        Guateroad.contraseña = txtPass.getText();
        pss = Guateroad.contraseña;
        password = Guateroad.fn.EncriptarSHA256(pss);
        System.out.println("pass "+password+" User "+Usuario);
        ...
        if(OpUser.isSelected())
        {
            ...
            if (Guateroad.ArbolUsuario.Buscar(Guateroad.id))
            {
                ...
                JOptionPane.showMessageDialog(null, "ERROR", "Datos incorrectos", JOptionPane.WARNING_MESSAGE);
